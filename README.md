...
- GET /v1/pets/active (remembered UX)
- “effective pet profile” (fallback из pets.profile, если не прислали pet_profile)
...
4. Pro-фичи: профиль питомца/история/память → фото → аудио(в работе/частично)
